...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.z-2
      ...
      .col-lg-8
        p Su función estratégica es acompañar al consumidor en las distintas etapas del recorrido digital, desde el descubrimiento hasta la decisión de compra. Por ejemplo, IKEA utiliza contenido visual inspirador para mostrar ambientes decorados, mientras que BBVA publica artículos educativos sobre finanzas personales para fortalecer la confianza del usuario.
        p.mb-0 El contenido efectivo se caracteriza por ser relevante, coherente con la identidad de marca y alineado con objetivos medibles.
    ...
    .row.justify-content-center.align-items-center.z-2.mb-4
      ...
      .col-xl-4.d-none.d-xl-block
        figure
          img(data-aos="fade-down-right", src="@/assets/curso/tema8/4.png", alt="")
      .col-lg-7.col-xl-5
        .p-4.rounded-4.bg-secundario-s5
          p.mb-0 Una arquitectura adecuada organiza los contenidos de manera jerárquica, clara y lógica, permitiendo que el usuario encuentre información sin dificultad. Empresas como Amazon estructuran sus categorías y subcategorías de manera intuitiva para facilitar la conversión, mientras que Airbnb organiza su plataforma según ubicación, tipo de alojamiento y experiencias.
    ...
    .row.justify-content-center.align-items-center.z-2.mb-5
      .col-lg-10.col-xl-8
        .titulo-sexto.color-acento-contenido.mb-4
          h5 Figura 4.
          span Componentes clave de la arquitectura web
        img.mb-2.d-sm-none(data-aos="fade-up", src="@/assets/curso/tema8/5-mob.png", alt="La figura 4 muestra componentes clave de la arquitectura web.")
        img.mb-2.d-none.d-sm-block(data-aos="fade-up", src="@/assets/curso/tema8/5.png", alt="La figura 4 muestra componentes clave de la arquitectura web.")
