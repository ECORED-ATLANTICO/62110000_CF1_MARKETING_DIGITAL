  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.z-2
      .col-lg-10.p-4.drop-shadow(data-aos="fade-down")
        div.banner-text
          p.mb-0 Los #[em insights] representan uno de los elementos más estratégicos dentro del #[em marketing] digital, ya que permiten comprender las motivaciones profundas del consumidor más allá de los datos superficiales. No se trata únicamente de identificar qué hace el usuario, sino de entender por qué lo hace. Un #[em insight] bien formulado orienta la creación de contenidos, el diseño de campañas y la construcción de propuestas de valor diferenciadas.
    ...
    .row.justify-content-center.align-items-center.mb-4.mb-lg-5.z-2
      ...
      .col-lg-8
        p Un #[em insight] es una interpretación profunda y reveladora sobre el comportamiento, las necesidades o las motivaciones del consumidor, obtenida a partir del análisis de datos y observación del entorno. Va más allá de un dato estadístico, porque explica la razón detrás de la conducta.
        .p-4.bg-terciario-t20.rounded-4.mb-4
          p.mb-0 Por ejemplo, un dato puede indicar que los usuarios abandonan un carrito de compra; el #[em insight] podría revelar que el motivo real es la desconfianza en los costos adicionales o en los tiempos de entrega. Esa comprensión permite ajustar la estrategia de manera efectiva. Empresas como Nike, Apple y Airbnb han construido campañas exitosas a partir de #[em insights] que conectan con emociones, aspiraciones y necesidades reales de sus públicos. El #[em insight] transforma la información en comprensión estratégica.
        p.mb-0 Un #[em insight] debe cumplir tres características: relevancia para el consumidor, conexión emocional y aplicabilidad estratégica.
    ...
    .row.justify-content-center.z-2.mb-4.mb-lg-5
      .col-xl-10
        .titulo-sexto.color-acento-contenido
          h5 Tabla 8.
          span Del #[em insight] a la acción estratégica
        .tabla-a.color-secundario
          table
            caption Nota. SENA, (2026).
            thead
              tr(style="background-color: #F1B6FC")
                th #[em Insight] identificado
